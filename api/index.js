...
mongoose.connect("mongodb+srv://Alex2o9z:Alex2o9z@cluster0.oh2y5ib.mongodb.net/kobisocialmedia?retryWrites=true&w=majority&appName=Cluster0", {
...
const sendVerificationEmail = async (email, verificationToken) => {
    const transport = nodeMailer.createTransport({
        service: "gmail",
        auth: {
            user: "httrinh.20it10@vku.udn.vn",
            pass: "trinhzxc123"
        }
    });
